...
gem_version = Module.new.tap { |mod| Kernel.load("#{__dir__}/lib/undrive_google/version.rb", mod) }::UndriveGoogle::Version::VERSION
...
Gem::Specification.new do |spec|
  ...
  # The 'git' gem is optional; undrive_google falls back to shelling out to `git` if it is not present.
